    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-6">
          {/* Reservation Summary */}
          <div>
            <h3 className="font-semibold mb-3">{t.reservationSummary}</h3>
          ...
          {preOrderItems.length > 0 && (
            <div>
              <h3 className="font-semibold mb-3">{t.preOrderSummary}</h3>
          ...
          <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
            <h3 className="font-medium">{t.gdprTitle}</h3>
          ...
          <div className="p-4 bg-blue-50 rounded-lg">
            <div className="flex items-start gap-3">
              <Shield className="h-5 w-5 text-[#237584] mt-0.5" />
              <div className="text-sm">
                <p className="font-medium text-blue-900 mb-1">{t.importantNotices}</p>
